...
@property (nonatomic) UILabel     *lbTemp;//当前温度
@property (nonatomic) UILabel     *lbWeatherInfo;//当前天气详情
@property (nonatomic) UILabel     *lbWind;//当前风向
@property (nonatomic) UILabel     *lbWindSpeed;//当前风向级别
